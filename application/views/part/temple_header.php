			...
			<div class="modal-body">
				<form role="form" action="<?php echo base_url('/user/update_self'); ?>" method="post">
					<div class="form-group">
						...
						<input type="email" class="form-control" name="email" id="exampleInputEmail1" placeholder="请输入邮箱"
						       value="<? echo $loginUserInfo['email'];//登陆者邮箱?>">
					</div>
					<div class="form-group">
						<label for="exampleInputPassword1">QQ号</label>
						<input type="text" class="form-control" name="qq" id="exampleInputQQ" placeholder="请输入QQ"
						       value="<? echo $loginUserInfo['qq'];//登陆者QQ?>">
					</div>
