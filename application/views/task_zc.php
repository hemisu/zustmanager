                    ...
                    <div class="profile-details">
                        <ul class="fa-ul">
                            ...
                            <li><i class="fa-li fa fa-qq"></i><strong>QQ:</strong>
                                <?if($userinfo['qq']){echo $userinfo['qq'];}else{echo "请尽快添加您的qq号";}?></li>
                            ...
                            <li><i class="fa-li glyphicon glyphicon-paperclip"></i><strong>Email:</strong>
                                <?if($userinfo['email']){echo $userinfo['email'];}else{echo "请尽快添加您的email";}?></li>
                    ...
                    <div class="main-box clearfix">
                        <div class="tabs-wrapper profile-tabs">
                            <ul class="nav nav-tabs">
                                <li><a href="#todolist" data-toggle="tab">待办事项</a>
                                </li>
                                        ...
                                        <div class="conversation-content">
                                            ...
                                            if ($query->num_rows() > 0)
                                            {
                                                foreach ( $query->result() as $row)
                                                {
                                                    ...
                                                    <div class="conversation-item <?if($row->fromid == $userinfo['student_id']) {echo "item-right";}else{echo "item-left";}?> clearfix">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?echo base_url('user/head_img')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
